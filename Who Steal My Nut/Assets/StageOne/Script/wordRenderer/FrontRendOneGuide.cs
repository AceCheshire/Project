...
public class FrontRendOneGuide : MonoBehaviour
{
    /*Important Static*/
    ...
    public Vector3Int rendRightBottom = new Vector3Int(308, -72, 0);
    ...
    void Start()
    {
        ...
        wordBuffer = GameObject.Find("wordBufferGuide").GetComponent<Tilemap>();
    ...
    void Update()
    {
        ...
        if (GameObject.Find("wordBufferGuide").
            GetComponent<WordTranslateOneGuide>().isWaitingFrontRend == true)
        {
            Flush();
            rendererStartPointer = new Vector3Int(0, 0, 0);
            Rend();
            GameObject.Find("wordBufferGuide").
                GetComponent<WordTranslateOneGuide>().isWaitingFrontRend = false;
        }// Rend ( with request )
