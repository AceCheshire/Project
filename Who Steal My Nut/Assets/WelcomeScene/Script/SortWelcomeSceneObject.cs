...
public class SortWelcomeSceneObject : MonoBehaviour
{
    ...
    /*Words*/
    public string readmeAlertPassage = "ONE REAL MAN\n" +
    "The ruler of an ancient kingdom wanted to disprove the statement that the men of his domain were ruled by their wives." +
    "He had all the males in his kingdom brought before him " +
    "and warned that any man who did not tell the truth would be punished severely.\n" +
    ...
    public string achievementAlertPassage = "For centuries, " +
